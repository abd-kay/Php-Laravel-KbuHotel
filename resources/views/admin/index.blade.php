                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body chat-box scrollable" style="height:300px;">
                            <ul class="chat-list">
                                <li class="chat-item">
                                    <div class="chat-img"><img src="{{asset('assets')}}/dashboard/img/users/1.jpg" alt="user"></div>
                                ...
                                <li class="chat-item">
                                    <div class="chat-img"><img src="{{asset('assets')}}/dashboard/img/users/2.jpg" alt="user"></div>
                                    <div class="chat-content">
                                ...
                                <li class="chat-item">
                                    <div class="chat-img"><img src="{{asset('assets')}}/dashboard/img/users/3.jpg" alt="user"></div>
                                    <div class="chat-content">
                ...
                <div class="col-md-4">
                    <div class="card" style="min-height: 422px;">
                        ...
                        <div class="card-body timeline">
                            <div class="header bg-theme" style="background-image: url('{{asset('assets')}}/dashboard/img/placeholder/placeimg_400_200_nature.jpg')">
                ...
                <div class="card-body">
                    <table id="advanced_table" class="table">
                        ...
                        <tr>
                            ...
                            <td><img src="{{asset('assets')}}/dashboard/img/users/1.jpg" class="table-user-thumb" alt=""></td>
                            <td>Tiger Nixon</td>
                        ...
                        <tr>
                            ...
                            <td><img src="{{asset('assets')}}/dashboard/img/users/2.jpg" class="table-user-thumb" alt=""></td>
                        ...
                        <tr>
                            ...
                            <td><img src="{{asset('assets')}}/dashboard/img/users/3.jpg" class="table-user-thumb" alt=""></td>
                            <td>Ashton Cox</td>
                        ...
                        <tr>
                            ...
                            <td><img src="{{asset('assets')}}/dashboard/img/users/4.jpg" class="table-user-thumb" alt=""></td>
                            <td>Cedric Kelly</td>
                        ...
                        <tr>
                            ...
                            <td><img src="{{asset('assets')}}/dashboard/img/users/5.jpg" class="table-user-thumb" alt=""></td>
                            <td>Airi Satou</td>
                            <td>Accountant</td>
                            <td>Tokyo</td>
                            <td>33</td>
